...
public class GamePlayController extends JPanel {
    ...
    gui.
        ...
        /*Game Board creation
        1. "FacesPanel" generates a game board
        2. Create two new panels that clone FacesPanel
        3. When passing between players, the corresponding panel and Player portrait will flip
         */
